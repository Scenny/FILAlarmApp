...
public class AlarmKlaxon extends Service {
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case KILLER:
                    Log.v("FourInLove", "*********** Alarm killer triggered ***********");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (alarm == null) {
            Log.v("FourInLove", "AlarmKlaxon failed to parse the alarm from the intent");
            stopSelf();
            return START_NOT_STICKY;
        }
    ...
    private void play(Alarm alarm) {
        ...
        if (!alarm.silent) {
            ...
            if (alert == null) {
                ...
                Log.v("FourInLove", "Using default alarm: " + alert.toString());
            }
            ...
            try {
                ...
                if (mTelephonyManager.getCallState()
                    ...
                    Log.v("FourInLove", "Using the in-call alarm");
                ...
                Log.v("FourInLove", "Using the fallback ringtone");
                ...
                try {
                    ...
                    Log.v("FourInLove", "Failed to play fallback ringtone"+ex2);
                }
            }
        }
     ...
     */
    public void stop() {
        Log.v("FourInLove", "AlarmKlaxon.stop()");
        if (mPlaying) {
            mPlaying = false;
